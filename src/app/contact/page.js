      ...
      >
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
          ...
          <Box sx={{ textAlign: 'center', maxWidth: '800px', mx: 'auto' }}>
            ...
            xs={12}
            md={6}
            sx={{ order: { xs: 1, md: 1 }, flex: { xs: 0, md: 1 } }}
            >
						<Box
							sx={{
								pr: { md: 2 },
							...
							<Typography
								...
								Ready to start your shopping journey? Reach out to us through
								...
								<Paper
									...
									sx={{
										...
										"&:hover": {
											...
											boxShadow: {
												xs: "0 4px 15px rgba(93, 64, 55, 0.12)",
												md: "0 8px 25px rgba(93, 64, 55, 0.15)",
											},
										},
									}}>
									<Box
										...
										<Box
											sx={{
												...
												background:
													"linear-gradient(135deg, #FFA000 0%, #FF8F00 100%)",
												display: "flex",
												alignItems: "center",
										...
										<Box sx={{ flex: 1 }}>
											...
											<Box
												...
												<Typography
													...
													<span>Sunday:</span>
													<span style={{ fontWeight: 500, color: "#757575" }}>
														Closed
													</span>
												</Typography>
											</Box>
					...
					<Grid
						...
						xs={12}
						md={6}
						sx={{ order: { xs: 1, md: 2 }, flex: { xs: 0, md: 1 }  }}
						>
						<Paper
							elevation={0}
							sx={{
				...
				<Container maxWidth='lg' sx={{ position: "relative", zIndex: 1 }}>
					<Box sx={{ textAlign: "center", mb: 6 }}>
						...
						<Typography
							...
							Find us at the heart of the city. We're always ready to welcome
							you with our premium collection.
						</Typography>
					</Box>
