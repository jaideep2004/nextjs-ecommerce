					...
					<Grid item xs={12} lg={6} sx={{ flex: { xs: 1, md: 1 } }}>
						<Box
							...
							<Typography
								...
								Sign in to your India Inspired account to continue your journey
								with authentic fashion and traditional elegance.
							</Typography>
						...
						<Box
							...
							<Card
								sx={{
									...
									background:
										theme.palette.mode === "dark" ? "#111111" : "white",
									border:
										theme.palette.mode === "dark"
										...
										sx={{
											...
											borderColor:
												theme.palette.mode === "dark"
													...
													: "#dadce0",
											color:
												theme.palette.mode === "dark" ? "#FFFFFF" : "#5f6368",
											textTransform: "none",
											fontSize: "1rem",
											fontWeight: 500,
											background:
											...
											"&:disabled": {
												background:
													theme.palette.mode === "dark"
														...
														: "#f8f9fa",
												color:
													theme.palette.mode === "dark" ? "#CCCCCC" : "#9aa0a6",
											},
										}}>
										{googleLoading ? (
											"Signing in..."
									...
									<form onSubmit={handleSubmit}>
										...
										<Button
											...
											sx={{
												...
												"&:hover": {
													background:
														"linear-gradient(135deg, #8b7d65, #6d5d4a)",
