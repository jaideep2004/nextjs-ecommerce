...
export default function Home() {
	...
	useEffect(() => {
		...
		const fetchProducts = async () => {
			try {
				...
				const [featuredRes, newArrivalsRes, saleRes, trendingRes] =
					await Promise.all([
				...
				const featuredData =
					featuredRes.data.products || featuredRes.data.data?.products || [];
				const newArrivalsData =
					newArrivalsRes.data.products ||
					newArrivalsRes.data.data?.products ||
					[];
				const saleData =
					saleRes.data.products || saleRes.data.data?.products || [];
				const trendingData =
					trendingRes.data.products || trendingRes.data.data?.products || [];
	...
	const features = [
		...
		},
		{
			...
			description:
				"Shop with confidence knowing that our payment system is secure.",
		},
	];
				...
				<Container maxWidth='xl'>
					<Box sx={{ textAlign: "center", mb: 6 }}>
						...
						<Typography
							...
							data-aos='fade-up'
							data-aos-delay='300'>
							Discover our most popular and highest-rated products that
							customers love
						</Typography>
					</Box>
        ...
        `,
          ...
          `,
				...
				{[...Array(8)].map((_, i) => {
					...
					const animationType = ["goldFloat", "goldDrift", "goldSparkle"][
						i % 3
					];
                  ...
                  `,
                    ...
                    `,
                        ...
                        `,
												...
												"&::before": {
													...
													height: "100%",
													background:
														"linear-gradient(90deg, transparent, rgba(162, 146, 120, 0.25), transparent)",
												...
												"&::after": {
													...
													borderRadius: "50%",
													background:
														"radial-gradient(circle, rgba(162, 146, 120, 0.05) 0%, transparent 70%)",
											...
											<Typography
												...
												sx={{
													...
													mb: 0.5,
													background:
														"linear-gradient(135deg, #2c2c2c 0%, #8b7355 100%)",
													WebkitBackgroundClip: "text",
													WebkitTextFillColor: "transparent",
							...
							<Box
								...
								<Box
									sx={{
										...
										borderRadius: "50%",
										background:
											"linear-gradient(45deg, rgba(162, 146, 120, 0.1), rgba(212, 192, 158, 0.15))",
								...
								<Box
									sx={{
										...
										borderRadius: "50%",
										background:
											"linear-gradient(45deg, rgba(255, 215, 0, 0.1), rgba(212, 192, 158, 0.12))",
                    ...
                    `,
										...
										"&::after": {
											...
											borderRadius: "20px",
											background:
												"linear-gradient(45deg, rgba(255, 215, 0, 0.05) 0%, transparent 30%, transparent 70%, rgba(255, 215, 0, 0.02) 100%)",
						...
						<Grid item xs={12} md={6} sx={{ order: { xs: 1, md: 2 } }}>
							<Box
								...
								<Typography
									...
									sx={{
										color: (theme) =>
											theme.palette.mode === "dark" ? "#b0b0b0" : "#666",
									...
									{[
										...
										<Box
											...
											<Typography
												...
												sx={{
													color: (theme) =>
														theme.palette.mode === "dark" ? "#c0c0c0" : "#555",
													fontSize: "1rem",
													fontWeight: 500,
												}}>
												{feature}
				...
				<Container maxWidth='lg' sx={{ position: "relative", zIndex: 2 }}>
                  ...
                  `,
										...
										"&::before": {
											...
											height: "100%",
											background:
												"linear-gradient(90deg, transparent, rgba(212, 192, 158, 0.2), transparent)",
                    ...
                    `,
								...
								<Typography
									...
									Discover authentic experiences from our valued customers who
									have transformed their style with our premium collection.
								</Typography>
								...
								<Box
									...
									<Typography
										...
										sx={{
											...
											fontStyle: "italic",
											color: (theme) =>
												theme.palette.mode === "dark" ? "#e0e0e0" : "#444",
											textAlign: "center",
											mb: 4,
											position: "relative",
											zIndex: 10,
          ...
          `,
				...
				<Box
					sx={{
						...
						height: "1px",
						background:
							"linear-gradient(90deg, transparent, rgba(212, 192, 158, 0.3), transparent)",
                  ...
                  `,
                    ...
                    `,
								...
								<Typography
									...
									offers, and style inspirations delivered straight to your
									inbox.
								</Typography>
										...
										<Box
											...
											<Box
												sx={{
													...
													borderRadius: "50%",
													background:
														"linear-gradient(45deg, #a29278, #d4c09e)",
													animation: `${dimensionalPulse} 2s ease-in-out infinite ${
														index * 0.3
													}s`,
												}}
											/>
